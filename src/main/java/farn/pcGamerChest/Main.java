...
public class Main implements ModInitializer {
    ...
    public static void initChest(World world) {
        ...
        Double chest
         */
        world.setBlockWithNotify(chestX, chestY, chestZ - 1, Block.chestLegacy.id);
        TileEntityChest chest1 = (TileEntityChest)world.getBlockTileEntity(chestX, chestY, chestZ - 1);
        world.setBlockWithNotify(chestX + 1, chestY, chestZ - 1, Block.chestLegacy.id);
        TileEntityChest chest2 = (TileEntityChest)world.getBlockTileEntity(chestX + 1, chestY, chestZ - 1);

        /*
        Gun Powder chest ( below double chest )
         */
        world.setBlockWithNotify(chestX, chestY - 4, chestZ, Block.chestLegacy.id);
        ...
        /*
        Double chest content

        wtf , flint and steel are called fire striker
         */
